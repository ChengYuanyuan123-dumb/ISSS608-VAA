...
gap_style <- function(value) {
  ...
  if (value >= 0) {
    list(color = "#1B5E20", fontWeight = "600")
  } else {
    list(color = "#B03A2E", fontWeight = "600")
  }
}
```
...
product_summary %>%
  ...
  geom_col(width = 0.68) +
  scale_x_continuous(labels = dollar) +
  scale_fill_manual(values = c("TRUE" = "#2A6F6F", "FALSE" = "#B03A2E"), guide = "none") +
  labs(
